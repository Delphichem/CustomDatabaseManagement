...
function  TDBEDatabase.GetTriggerNames: TStringList;
begin
   Result := TStringList.Create;
end;

function  TDBEDatabase.GetViewNames: TStringList;
begin
   Result := TStringList.Create;
end;

function  TDBEDatabase.GetStoredProcSQL(aStoredProcName : String) : string;
begin
   Result := '';
end;

function  TDBEDatabase.GetTriggerSQL(aTriggerName : String) : string;
begin
   Result := '';
end;

function  TDBEDatabase.GetViewSQL(aViewName : String) : string;
begin
   Result := '';
end;
...
begin
   Result := 0;
   //Result := StrToInt(fConnection.Params.Values['Timeout']);
end;
...
begin
  inherited;
  //fConnection.Params.Values['Timeout'] := IntToStr(aTimeout);
end;
